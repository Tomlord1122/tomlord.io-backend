...
const getBlogWithMessageCount = `-- name: GetBlogWithMessageCount :one
SELECT 
    b.id, b.title, b.slug, b.date, b.lang, b.duration, b.tags, b.description, b.is_published, b.created_at, b.updated_at,
...
type GetBlogWithMessageCountRow struct {
...
func (q *Queries) GetBlogWithMessageCount(ctx context.Context, id pgtype.UUID) (GetBlogWithMessageCountRow, error) {
	row := q.db.QueryRow(ctx, getBlogWithMessageCount, id)
	var i GetBlogWithMessageCountRow
	err := row.Scan(
		&i.ID,
		&i.Title,
		&i.Slug,
